...
def mirror_cavity_holes(name, coord, thick, mirror_dx, dia_1, dia_2, num_holes, start_pos):
...
def gaussian_cavity_holes(name, coord, thick, mirror_dx, dia_1, dia_2, gauss_std, num_holes, preview):
...
def quadratic_cavity_holes(name, coord, thick, mirror_dx, dia_1, dia_2, quad_constant, num_holes, preview):
...
def dipole(coord, wave_center, wave_width, theta, phi):
    x = coord[0]
    y = coord[1]
    z = coord[2]
    fdtd.adddipole()
...
def gaussian_x(name, coord, height, width, mode, wave_center, wave_width, theta=0):
    x = coord[0]
    y = coord[1]
    z = coord[2]
    fdtd.addmode()
...
def gaussian_y(name, coord, height, width, mode, wave_center, wave_width, theta=0):
    x = coord[0]
    y = coord[1]
    z = coord[2]
    fdtd.addmode()
...
def gaussian_z(name, coord, height, width, mode, wave_center, wave_width, theta=0):
    x = coord[0]
    y = coord[1]
    z = coord[2]
    fdtd.addmode()
...
def profile_xy(coord, height, width, bool, freq_point=None, wave_center=None, wave_width=None):
    x = coord[0]
    y = coord[1]
    z = coord[2]
    fdtd.addprofile()
...
def profile_xz(coord, height, width, bool, freq_point=None, wave_center=None, wave_width=None):
    x = coord[0]
    y = coord[1]
    z = coord[2]
    fdtd.addprofile()
...
def profile_yz(coord, height, width, bool, freq_point=None, wave_center=None, wave_width=None):
    x = coord[0]
    y = coord[1]
    z = coord[2]
    fdtd.addprofile()
...
def volume_monitor(coord, xspan, yspan, zspan, bool, freq_point=None, wave_center=None, wave_width=None):
    x = coord[0]
    y = coord[1]
    z = coord[2]
    fdtd.addprofile()
...
def farfield_run_save(monitor_name, filename, wave_center, wave_width, freq_point=None):
    if freq_point == None:
        freq_point = 5
    wave_list = np.linspace(wave_center-wave_width/2, wave_center+wave_width/2, freq_point)
    ...
    results_dict = {'wavelength': wave_list.tolist(),
...
def sim_vol_params(params_dict, count, tsim, coord, accuracy, mesh_res, xspan, yspan, zspan):
    component = 'sim'
    dict = {}
...
def sim_surface_xy_params(params_dict, count, tsim, coord, accuracy, mesh_res, xspan, yspan):
...
def gaussian_x_params(params_dict, count, coord, height, width, mode, wave_center, wave_width, theta):
...
def gaussian_y_params(params_dict, count, coord, height, width, mode, wave_center, wave_width, theta):
...
def profile_xy_params(params_dict, count, coord, height, width, bool, freq_point=None, wave_center=None, wave_width=None):
...
def profile_xz_params(params_dict, count, coord, height, width, bool, freq_point=None, wave_center=None, wave_width=None):
...
def profile_yz_params(params_dict, count, coord, height, width, bool, freq_point=None, wave_center=None, wave_width=None):
...
def line_x_params(params_dict, count, coord, width, bool, freq_point=None, wave_center=None, wave_width=None):
    component = 'line_xz'
    dict={}
    dict[f'{component}_coord_{count}']=coord
    dict[f'{component}_width_{count}']=width
...
def point_monitor_params(params_dict, count, coord, bool, freq_point=None, wave_center=None, wave_width=None):
...
def volume_monitor_params(params_dict, count, coord, xspan, yspan, zspan, bool, freq_point=None, wave_center=None, wave_width=None):
...
def importgds_params(params_dict, count, name, coord, material, thick, filename, cellname, layer):
    component = 'importgds'
    dict={}
