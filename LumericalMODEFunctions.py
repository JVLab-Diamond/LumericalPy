...
def sim_yNormal_params(params_dict, coord, width, heigth, cell_num=[], mesh_res=[], bc_type='Metal'):
...
def sim_xNormal_params(params_dict, coord, width, heigth, cell_num=[], mesh_res=[], bc_type='Metal'):
...
def sim_zNormal_params(params_dict, coord, width, heigth, cell_num=[], mesh_res=[], bc_type='Metal'):
